...
parser.add_argument('--path', type=str, default=['celebahq_stat2.npy', '../saved_info/celeba_256/celeba_dgan/generated_samples'], help=('Paths to the generated images or to .npz statistic files'))
